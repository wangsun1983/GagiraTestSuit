...
int main() {
    ...
    Thread waitT1 = Thread::New([&] {
        ...
        if(cost > 120 || cost < 100) {
            TEST_FAIL("testQueue2ClientWaitCloseConnection case1,cost is %d",cost);
        }
    ...
    Thread waitT2 = Thread::New([&] {
        ...
        if(cost > 120 || cost < 100) {
            TEST_FAIL("testQueue2ClientWaitCloseConnection case4");
        }
    ...
    setEnvPort(++port);
    sleep(1);
    TEST_OK("testQueue2ClientWaitCloseConnection case100");
    return 0;
}
