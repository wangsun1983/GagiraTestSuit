...
int main() {
    ...
    if(ret1 == 0) {
        TEST_FAIL("testDocuement Open read in writing case1,ret is %d",ret1);
    }

    if(fileno1 != 0) {
        TEST_FAIL("testDocuement Open read in writing case2,fileno is %d",fileno1);
    }
    ...
    if(ret2 != 0) {
        TEST_FAIL("testDocuement Open read in writing case3,ret is %d",ret2);
    }

    if(fileno2 == 0) {
        TEST_FAIL("testDocuement Open read in writing case4,fileno is %d",fileno2);
    }

    setEnvPort(++port);
    
    TEST_OK("testDocuement Open read in writing case100");
    return 0;
}
