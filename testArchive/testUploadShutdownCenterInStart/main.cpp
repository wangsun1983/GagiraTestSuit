...
int main() {
    ...
    c->upload(f,[&center](int status,int progress) {
    ...
    if(uploadFile->exists()) {
        TEST_FAIL("testDocuement upload shutdown center in start case1");
        return 0;
    }

    
    TEST_OK("testDocuement upload shutdown center in start case100");
