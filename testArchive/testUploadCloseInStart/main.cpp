...
int main() {
    ...
    c->upload(f,[&c](int status,int progress) {
    ...
    if(uploadFile->exists()) {
        TEST_FAIL("testDocuement upload close connection in start case1");
        return 0;
    }

    
    TEST_OK("testDocuement upload close connection in start case100");
