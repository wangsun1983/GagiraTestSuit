...
int main() {
    ...
    if(ret1 == 0) {
        TEST_FAIL("testDocuement Open writing in reading case1,ret is %d",ret1);
    }

    if(fileno1 != 0) {
        TEST_FAIL("testDocuement Open writing in reading case2,fileno is %d",fileno1);
    }
    ...
    if(ret2 != 0) {
        TEST_FAIL("testDocuement Open writing in reading case3,ret is %d",ret2);
    }

    if(fileno2 == 0) {
        TEST_FAIL("testDocuement Open writing in reading case4,fileno is %d",fileno2);
    }

    setEnvPort(++port);
    
    TEST_OK("testDocuement Open writing in reading case100");
    return 0;
}
